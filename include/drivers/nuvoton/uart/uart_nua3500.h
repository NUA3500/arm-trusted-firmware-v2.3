...
#ifndef UART_nua3500_H
#define UART_nua3500_H

#include <drivers/console.h>

/* UART nua3500 Registers */
#define UARTTX			0x0
#define UARTRX			0x0
#define UARTIER			0x4
#define UARTFCR			0x8
...
/*
 * Initialize a new nua3500 console instance and register it with the console
 ...
 * case as well.
 */
int console_nua3500_register(uintptr_t baseaddr, uint32_t clock, uint32_t baud,
			   console_t *console);

#endif /*__ASSEMBLER__*/

#endif /* UART_nua3500_H */
