...
void nua3500_wb_ddr3_512mb(void)
{
	...
	//set PWRCTL
	outp32(UMCTL2_BA + 0x030,0x00000001);  //mod
	...
	//set INIT3
	outp32(UMCTL2_BA + 0x0dc,0x1b400006);  //mod 20201109

	//set INIT4
	outp32(UMCTL2_BA + 0x0e0,0x00480000);  //mod 20200822
	...
	//set DRAMTMG0
	outp32(UMCTL2_BA + 0x100,0x090d110a);  //mod 20200619
...
#else
	outp32(UMCTL2_BA + 0x198,0x0700b030);  //mod 20200825
#endif
	...
	//set PGCR1,addr=3
	outp32(DDRPHY_BA + 0x00c,0x0300c461);  //mod 20200608
	...
	//set MR1,addr=22
	outp32(DDRPHY_BA + 0x058,0x00000006);  //mod 20201109

	//set MR2,addr=23
	outp32(DDRPHY_BA + 0x05c,0x00000048);  //mod 20200822
	...
	//set ZQ0CR1,addr=97
	outp32(DDRPHY_BA + 0x184,0x0000105d);  //mod 20201109
	...
	//set DTCR,addr=26
	outp32(DDRPHY_BA + 0x068,0x91003587);  //mod 20200820

	//set PIR,addr=1
	outp32(DDRPHY_BA + 0x004,0x0000ff81);

	//polling PGSR0 (addr=4) to 0xb0000fff
	while((inp32(DDRPHY_BA + 0x010) & 0xffffffff) != 0xb0000fff);
...
void nua3500_mt_ddr3_1gb(void)
{
	...
	//set RFSHTMG
	outp32(UMCTL2_BA + 0x064,0x0041005e);  //mod 20200324
	...
	//set DRAMTMG0
	outp32(UMCTL2_BA + 0x100,0x090e110a);  //mod 20200619

	//set DRAMTMG1
	outp32(UMCTL2_BA + 0x104,0x0003020e);

	//set DRAMTMG2
	outp32(UMCTL2_BA + 0x108,0x00000407);

	//set DRAMTMG3
	outp32(UMCTL2_BA + 0x10c,0x00002006);

	//set DRAMTMG4
	outp32(UMCTL2_BA + 0x110,0x04020305);  //mod 20200529

	//set DRAMTMG5
	outp32(UMCTL2_BA + 0x114,0x03030202);
	...
	//set ADDRMAP0
	outp32(UMCTL2_BA + 0x200,0x00000017);  //mod 20200117,for 2G bytes
	...
	//set ADDRMAP6
	outp32(UMCTL2_BA + 0x218,0x07070707);  //mod 20200117,for 2G bytes
	...
	//set SARSIZE0
	outp32(UMCTL2_BA + 0xf08,0x00000007);  //mod 20200117,for 2G bytes
	...
	//set PTR3,addr=10
	outp32(DDRPHY_BA + 0x028,0x0c04111d);  //mod 20200511

	//set PTR4,addr=11
	outp32(DDRPHY_BA + 0x02c,0x0801a072);  //mod 20200511
	...
	//set DTPR0,addr=18
	outp32(DDRPHY_BA + 0x048,0x75959955);  //mod 20200511

	//set DTPR1,addr=19
	outp32(DDRPHY_BA + 0x04c,0x1685e360);  //mod 20200324
	...
	//set DTCR,addr=26
	outp32(DDRPHY_BA + 0x068,0x93003587);  //mod 20200820
...
void nua3500_wb_ddr2_128mb(void)
{
	//set DBG1
	outp32(UMCTL2_BA + 0x304,0x00000001);
	...
	//set MSTR
	outp32(UMCTL2_BA + 0x000,0x01040000);

	//set MRCTRL0
	outp32(UMCTL2_BA + 0x010,0x00001010);  //mod 20200511
	...
	//set RFSHTMG
	outp32(UMCTL2_BA + 0x064,0x00410022);  //mod 20200306

	//set CRCPARCTL0
	outp32(UMCTL2_BA + 0x0c0,0x00000000);

	//set INIT0
	outp32(UMCTL2_BA + 0x0d0,0x40020035);  //mod 20200309

	//set INIT1
	outp32(UMCTL2_BA + 0x0d4,0x00010002);

	//set INIT3
	outp32(UMCTL2_BA + 0x0dc,0x0e730004);  //mod 20200918

	//set INIT4
	outp32(UMCTL2_BA + 0x0e0,0x00000000);

	//set INIT5
	outp32(UMCTL2_BA + 0x0e4,0x00010000);

	//set DIMMCTL
	outp32(UMCTL2_BA + 0x0f0,0x00000000);

	//set RANKCTL
	outp32(UMCTL2_BA + 0x0f4,0x0000031f);

	//set DRAMTMG0
	outp32(UMCTL2_BA + 0x100,0x090c110c);  //mod 20200619

	//set DRAMTMG1
	outp32(UMCTL2_BA + 0x104,0x0003030e);  //mod 20200309

	//set DRAMTMG2
	outp32(UMCTL2_BA + 0x108,0x00000407);  //mod 20200103

	//set DRAMTMG3
	outp32(UMCTL2_BA + 0x10c,0x00001004);

	//set DRAMTMG4
	outp32(UMCTL2_BA + 0x110,0x03010304);  //mod 20200103

	//set DRAMTMG5
	outp32(UMCTL2_BA + 0x114,0x01010202);  //mod 20200103

	//set DRAMTMG8
	outp32(UMCTL2_BA + 0x120,0x00000502);

	//set DRAMTMG15
	outp32(UMCTL2_BA + 0x13c,0x80000032);  //mod 20200225

	//set ZQCTL0
	outp32(UMCTL2_BA + 0x180,0xc0000000);

	//set ZQCTL1
	outp32(UMCTL2_BA + 0x184,0x00074bf0);
	...
	//set ADDRMAP0
	outp32(UMCTL2_BA + 0x200,0x0000001f);
	...
	//set ADDRMAP6
	outp32(UMCTL2_BA + 0x218,0x0f0f0f07);
	...
	//set ODTCFG
	outp32(UMCTL2_BA + 0x240,0x07010708);
	...
	//set SARSIZE0
	outp32(UMCTL2_BA + 0xf08,0x00000000);
	...
	//set PTR3,addr=10
	outp32(DDRPHY_BA + 0x028,0x0d61a072);

	//set PTR4,addr=11
	outp32(DDRPHY_BA + 0x02c,0x0559a072);

	//set MR0,addr=21
	outp32(DDRPHY_BA + 0x054,0x00000e73);  //mod 20200918

	//set MR1,addr=22
	outp32(DDRPHY_BA + 0x058,0x00000004);

	//set MR2,addr=23
	outp32(DDRPHY_BA + 0x05c,0x00000000);

	//set DTPR0,addr=18
	outp32(DDRPHY_BA + 0x048,0x71987755);  //mod 20200504

	//set DTPR1,addr=19
	outp32(DDRPHY_BA + 0x04c,0x22822322);

	//set DTPR2,addr=20
	outp32(DDRPHY_BA + 0x050,0x0641a8c8);  //mod 20200309

	//set ZQ0CR1,addr=97
	outp32(DDRPHY_BA + 0x184,0x0000104b);  //mod 20201014

	//polling PGSR0 (addr=4) to 0x0000000f
	while((inp32(DDRPHY_BA + 0x010) & 0x0000000f) != 0x0000000f);

	//set DCR,addr=17
	outp32(DDRPHY_BA + 0x044,0x0000040a);

	//set DTCR,addr=26
	outp32(DDRPHY_BA + 0x068,0x91003587);

	//set PIR,addr=1
	outp32(DDRPHY_BA + 0x004,0x0000f501);

	//polling PGSR0 (addr=4) to 0xb0000f5f
	while((inp32(DDRPHY_BA + 0x010) & 0xffffffff) != 0xb0000f5f);
...
void nua3500_ddr_init(void)
{
	...
	if (fdt_node_offset_by_compatible(fdt, -1, "wb-ddr3-512mb") >= 0) {
		nua3500_wb_ddr3_512mb();
	} else if (fdt_node_offset_by_compatible(fdt, -1, "mt-ddr3-1gb") >= 0) {
		nua3500_mt_ddr3_1gb();
	} else if (fdt_node_offset_by_compatible(fdt, -1, "wb-ddr2-128mb") >= 0) {
		nua3500_wb_ddr2_128mb();
	} else if (fdt_node_offset_by_compatible(fdt, -1, "run_pz1") >= 0) {
		nua3500_run_pz1();
	} else {
